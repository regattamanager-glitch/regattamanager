...
await transporter.sendMail({
  ...
  to: email,
  subject: "Your Security Code for Regatta Manager",
  html: `
  <!DOCTYPE html>
  <html lang="en">
  <head>
    ...
    <title>Regatta Manager Security Code</title>
  </head>
          ...
          <table width="600" cellpadding="0" cellspacing="0" border="0" bgcolor="#001f3f" style="border-collapse:collapse;">
            ...
            <tr>
              <td bgcolor="#112d5c" style="padding:40px 30px;color:#e2e8f0;">
                <h2 style="margin-top:0;font-size:20px;color:#ffffff;">Security code for your login</h2>
                <p style="font-size:15px;line-height:1.6;color:#e2e8f0;">
                  You recently attempted to sign in to <strong>Regatta Manager</strong>.
                ...
                <p style="font-size:14px;color:#e2e8f0;">This code is valid for <strong>5 minutes</strong>.</p>
